		...
		$(document).ready(function(){
			...
			var grid = $("#grid-basic").bootgrid({
				...
				grid.find(".command-edit").on("click", function(e){
					location.href="MantenedorTipoEjercicio.php?t=" + $(this).data("row-id");
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Tipo Ejercicio</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">							
								<table id="grid-basic" class="table table-condensed table-hover table-striped">
									...
									$listartipoeje = $data->listarTiposEjercicios();
									if($listartipoeje)
									foreach($listartipoeje as $eje):
									?>
										<tr>
											<td></td>
											<td><?php echo $eje->IdTipoEjercicio; ?></td>
											<td><?php echo $eje->Nombre; ?></td>
										</tr>
									<?php endforeach;?>
									</tbody>
								</table>  
