...
/*
	...
	$datosAlumno = $_SESSION['datosusuario']; 
     $personaAlumn = new Persona();
     
     $persona = $personaAlumn->obtenerAlumno($datosAlumno->Login);
...
$('#form1').submit(function(){
	...
	<?php if(isset($_SESSION["guardadookpersona"])){ ?>
	    BootstrapDialog.show({
			...
			message: '<h5>Datos guardados correctamente!</h5>',
			closable: true,
		    draggable: true,
			buttons: [{
				label: 'Ok',
                        ...
                        <div class="col-lg-6">
                            <div class="card-box">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rut" name="rut" readOnly="true" parsley-trigger="change" required placeholder="ej. 11.111.111-1"
                                           class="form-control"/>                           
                                </div>
                                <div class="form-group">
                                    <label for="nombres">
                                        Nombres*</label>
                                    <input type="text" name="nombres" readOnly="true" parsley-trigger="change" required placeholder="Ingresar Nombres"
                                        class="form-control" id="nombres">
                                </div>
                                <div class="form-group">
                                    <label for="userName">
                                        Apellido Paterno*</label>
                                    <input type="text" name="apellidop" readOnly="true" parsley-trigger="change" required placeholder="Ingresar Apellido Paterno"
                                        class="form-control" id="apellidop">
                                </div>
                                <div class="form-group">
                                    <label for="userName">
                                        Apellido Materno*</label>
                                    <input type="text" name="apellidom" readOnly="true" parsley-trigger="change" required placeholder="Ingresar Apellido Materno"
                                ...
                                <div class="form-group text-right m-b-0">
                                    ...
                                    <a class="btn btn-default waves-effect waves-light m-l-5" href="../bandejaAlumno.php">
