                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card-box">
                                ...
                                <form action="registroNivel.php" method="POST" data-parsley-validate novalidate>
                                <div class="form-group">
                                    <label for="userName">
                                        Nombre</label>
                                    <input type="text" name="nombre" parsley-trigger="change" required placeholder="Ingresar Código"
								...
								<div class="form-group">
                                    <label for="userName">
                                        Vigente</label>
                                    <select class="selectpicker  form-control" data-style="btn-white" name="vigente" , id="vigente">
