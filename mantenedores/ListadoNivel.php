		...
		$(document).ready(function(){
			...
			var grid = $("#grid-basic").bootgrid({
				...
				grid.find(".command-edit").on("click", function(e){
					location.href="MantenedorNivel.php?n=" + $(this).data("row-id");
				}).end().find(".command-delete").on("click", function(e){
					var idEliminar = $(this).data("row-id");
					BootstrapDialog.confirm({
						title: '<span class="glyphicon glyphicon-alert" aria-hidden="true"></span> Confirmacion',
						message: '¿En Realidad desea eliminar el Nivel?',
						draggable: true,
						type: BootstrapDialog.TYPE_WARNING,
						size: BootstrapDialog.SIZE_SMALL,
						callback: function(result){
							if(result) {
								location.href="acciones/elimina_nivel.php?n=" + idEliminar;
							}
						}
					});
				});
			...
			<?php unset($_SESSION["NivelEliminado"]); } ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Registro de Niveles / Niveles</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
								<a class="btn btn-primary waves-effect waves-light" href="MantenedorNivel.php">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo Nivel
								</a>
