                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-20">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="selectpicker  form-control" data-style="btn-white">
                                                    <option>- - Seleccione - - </option>
                                                    <option>Level 1</option>													<option>Level 1A</option>													<option>Level 1B</option>													<option>Level 2</option>													<option>Level 2A</option>													<option>Level 2B</option>													<option>Level 3</option>													<option>Level 3A</option>													<option>Level 3B</option>													<option>Level 4</option>													<option>Level 4A</option>													<option>Level 4B</option>													<option>Level 5</option>													<option>Level 5A</option>													<option>Level 5B</option>													<option>Level 6</option>													<option>Level 6A</option>													<option>Level 6B</option>													<option>Level Maintenance</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="userName">
