		...
		$(document).ready(function(){
			...
			var grid = $("#grid-basic").bootgrid({
				...
				grid.find(".command-edit").on("click", function(e){
					location.href="MantenedorPerfil.php?p=" + $(this).data("row-id");
				}).end().find(".command-delete").on("click", function(e){
					var idEliminar = $(this).data("row-id");
					BootstrapDialog.confirm({
						title: '<span class="glyphicon glyphicon-alert" aria-hidden="true"></span> Confirmacion',
						message: '¿En Realidad desea eliminar el Perfil?',
						draggable: true,
						type: BootstrapDialog.TYPE_WARNING,
						size: BootstrapDialog.SIZE_SMALL,
						callback: function(result){
							if(result) {
								location.href="acciones/elimina_perfil.php?p=" + idEliminar;
							}
						}
					});
				});
			...
			<?php if(isset($_SESSION["perfilEliminado"]) == '1'){ ?>
				...
				BootstrapDialog.show({
					...
					message: '<h5>Perfil Eliminado correctamente!</h5>',
					closable: true,
					draggable: true,
					buttons: [{
						label: 'Ok',
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
								<a class="btn btn-primary waves-effect waves-light" href="MantenedorPerfil.php">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo Perfil
								</a>
