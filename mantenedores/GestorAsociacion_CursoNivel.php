...
<head>
	...
	<?php if(isset($_SESSION["asociacion_oknivel"])){ ?>
	    BootstrapDialog.show({
			...
			<?php unset($_SESSION["asociacion_oknivel"]); } ?>
	});
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box" style="height: 450px;">
                                ...
                                <form id="frmasoc" action="guardar_asociacion_cursonivel.php" data-parsley-validate novalidate method="post">
                                		
		
                                <div class="col-lg-5">
                                	<div class="form-group">
                                    	<label for="nivel">Niveles Enrrolados</label>
                               			<select id="slEnrrolados" name="slEnrrolados[]" multiple="multiple" size="15" class="selectpicker  form-control" data-style="btn-white">
                               				<?php $data = new Data();  
											foreach($data->listarNivelEnrrolados($idCurso) as $enrrolados):?>
                               					<option value="<?php echo $enrrolados->Id_Nivel;?>"><?php echo $enrrolados->Nombre;?></option>
                               				<?php endforeach;?>
                               			</select>
                                	</div>
                                </div>			
                                ...
                                <div class="col-lg-5">
                                	<div class="form-group">
                                    	<label for="nivel">Niveles Disponibles</label>
                               			<select id="slDesEnrrolados" multiple="multiple" size="15" class="selectpicker  form-control" data-style="btn-white">
                               				<?php  $data = new Data(); 
											foreach($data->listarNivelnoEnrrolados($idCurso) as $noEnrrolados):?>
                               					<option value="<?php echo $noEnrrolados->Id_Nivel;?>"><?php echo $noEnrrolados->Nombre;?></option>
                               				<?php endforeach;?>
                               			</select>
                                	</div>	
                                </div>			
