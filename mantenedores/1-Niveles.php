                                    ...
                                    <div id="collapseOne-2" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ul>
                                                <li>Fase 1
                                                    <ul>
                                                        <li><a href="../Ejercicio_MultipleChoice.php">1 Multiple Choice, Select Correct (Unit 1 Vocabulary Practice I)</a></li>
                                                        <li><a href="../Ejercicio_FillInBlank.php">1 Fill in Blank, Mark Correct (Unit 1 To Be Practice I)</a></li>
                                                    </ul>
                                                </li>
                                                <li>Fase 2
                                                    <ul>
                                                        <li><a href="#">1 Drag and Drop Put in Order (Unit 1 Vocabulary Practice I)</a></li>
                                                        <li><a href="#">1 Fill in Blank, Mark Correct (Unit 1 To Be Practice I)</a></li>
                                                    </ul>
                                                </li>
                                                <li>Fase 3
                                                    <ul>
