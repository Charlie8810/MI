		...
		$(document).ready(function(){
			...
			var grid = $("#grid-basic").bootgrid({
				...
				grid.find(".command-edit").on("click", function(e){
					location.href="MantenedorEstado.php?e=" + $(this).data("row-id");
					...
					BootstrapDialog.confirm({
						...
						callback: function(result){
							if(result) {
								location.href="acciones/elimina_estado.php?e=" + idEliminar;
							}
						}
					});
				});
			...
			<?php if(isset($_SESSION["estadoEliminado"])){ ?>
			...
			<?php unset($_SESSION["estadoEliminado"]); } ?>
